...
read -r -d '' ops <<EOF
  ...
  ${CYAN}convertDocumentCsvToXlsx${OFF};CSV to Excel XLSX (AUTH)
  ${CYAN}convertDocumentDocToDocx${OFF};Word DOC (97-03) to DOCX (AUTH)
  ${CYAN}convertDocumentDocToPdf${OFF};Word DOC (97-03) to PDF (AUTH)
  ${CYAN}convertDocumentDocxToPdf${OFF};Word DOCX to PDF (AUTH)
  ${CYAN}convertDocumentPdfToPngArray${OFF};PDF to PNG Array (AUTH)
  ${CYAN}convertDocumentPptToPdf${OFF};PowerPoint PPT (97-03) to PDF (AUTH)
  ${CYAN}convertDocumentPptToPptx${OFF};PowerPoint PPT (97-03) to PPTX (AUTH)
  ${CYAN}convertDocumentPptxToPdf${OFF};PowerPoint PPTX to PDF (AUTH)
  ${CYAN}convertDocumentXlsToPdf${OFF};Excel XLS (97-03) to PDF (AUTH)
  ${CYAN}convertDocumentXlsToXlsx${OFF};Excel XLS (97-03) to XLSX (AUTH)
  ${CYAN}convertDocumentXlsxToCsv${OFF};Excel XLSX to CSV (AUTH)
  ${CYAN}convertDocumentXlsxToPdf${OFF};Excel XLSX to PDF (AUTH)
EOF
echo "  $ops" | column -t -s ';'
    echo ""
...
read -r -d '' ops <<EOF
  ${CYAN}convertWebHtmlToDocx${OFF};HTML to DOCX (AUTH)
...
read -r -d '' ops <<EOF
  ...
  ${CYAN}editDocumentDocxBody${OFF};Get body from a DOCX (AUTH)
  ${CYAN}editDocumentDocxGetHeadersAndFooters${OFF};Get content of a footer from a DOCX (AUTH)
  ${CYAN}editDocumentDocxGetImages${OFF};Get images from a DOCX (AUTH)
  ${CYAN}editDocumentDocxGetSections${OFF};Get sections from a DOCX (AUTH)
  ${CYAN}editDocumentDocxGetStyles${OFF};Get styles from a DOCX (AUTH)
  ${CYAN}editDocumentDocxGetTables${OFF};Get tables in DOCX (AUTH)
  ${CYAN}editDocumentDocxInsertImage${OFF};Insert image into a DOCX (AUTH)
  ${CYAN}editDocumentDocxInsertParagraph${OFF};Insert a new paragraph into a DOCX (AUTH)
  ${CYAN}editDocumentDocxInsertTable${OFF};Insert a new table into a DOCX (AUTH)
  ${CYAN}editDocumentDocxRemoveHeadersAndFooters${OFF};Remove headers and footers from DOCX (AUTH)
  ${CYAN}editDocumentDocxRemoveObject${OFF};Delete any object in a DOCX (AUTH)
  ${CYAN}editDocumentDocxReplace${OFF};Replace string in DOCX (AUTH)
  ${CYAN}editDocumentDocxSetFooter${OFF};Set the footer in a DOCX (AUTH)
  ${CYAN}editDocumentDocxSetHeader${OFF};Set the header in a DOCX (AUTH)
  ${CYAN}editDocumentFinishEditing${OFF};Download result from document editing (AUTH)
  ${CYAN}editDocumentPptxReplace${OFF};Replace string in PPTX (AUTH)
  ${CYAN}editDocumentXlsxGetColumns${OFF};Get rows and cells from a XLSX worksheet (AUTH)
  ${CYAN}editDocumentXlsxGetImages${OFF};Get images from a XLSX worksheet (AUTH)
  ${CYAN}editDocumentXlsxGetRowsAndCells${OFF};Get rows and cells from a XLSX worksheet (AUTH)
  ${CYAN}editDocumentXlsxGetStyles${OFF};Get styles from a XLSX worksheet (AUTH)
  ${CYAN}editDocumentXlsxGetWorksheets${OFF};Get worksheets from a XLSX (AUTH)
  ${CYAN}editDocumentXlsxInsertWorksheet${OFF};Insert a new worksheet into an XLSX spreadsheet (AUTH)
EOF
echo "  $ops" | column -t -s ';'
    echo ""
    echo -e "${BOLD}${WHITE}[mergeDocument]${OFF}"
read -r -d '' ops <<EOF
  ${CYAN}mergeDocumentDocx${OFF};Merge Multple Word DOCX Together (AUTH)
  ${CYAN}mergeDocumentPptx${OFF};Merge Multple PowerPoint PPTX Together (AUTH)
  ${CYAN}mergeDocumentXlsx${OFF};Merge Multple Excel XLSX Together (AUTH)
EOF
echo "  $ops" | column -t -s ';'
    echo ""
...
print_convertDataXmlToJson_help() {
    echo ""
    echo -e "${BOLD}${WHITE}convertDataXmlToJson - XML to JSON conversion${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_convertDocumentAutodetectGetInfo_help() {
    ...
    echo -e ""
    echo -e "Auto-detects a document's type information; does not require file extension.  Analyzes file contents to confirm file type." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
...
print_convertDocumentAutodetectToPdf_help() {
    ...
    echo -e ""
    echo -e "Automatically detect file type and convert it to PDF." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
...
print_convertDocumentCsvToXlsx_help() {
    echo ""
    echo -e "${BOLD}${WHITE}convertDocumentCsvToXlsx - CSV to Excel XLSX${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_convertDocumentDocToDocx_help() {
    echo ""
    echo -e "${BOLD}${WHITE}convertDocumentDocToDocx - Word DOC (97-03) to DOCX${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_convertDocumentDocToPdf_help() {
    echo ""
    echo -e "${BOLD}${WHITE}convertDocumentDocToPdf - Word DOC (97-03) to PDF${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_convertDocumentDocxToPdf_help() {
    echo ""
    echo -e "${BOLD}${WHITE}convertDocumentDocxToPdf - Word DOCX to PDF${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_convertDocumentPdfToPngArray_help() {
    echo ""
    echo -e "${BOLD}${WHITE}convertDocumentPdfToPngArray - PDF to PNG Array${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_convertDocumentPptToPdf_help() {
    echo ""
    echo -e "${BOLD}${WHITE}convertDocumentPptToPdf - PowerPoint PPT (97-03) to PDF${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_convertDocumentPptToPptx_help() {
    echo ""
    echo -e "${BOLD}${WHITE}convertDocumentPptToPptx - PowerPoint PPT (97-03) to PPTX${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_convertDocumentPptxToPdf_help() {
    echo ""
    echo -e "${BOLD}${WHITE}convertDocumentPptxToPdf - PowerPoint PPTX to PDF${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_convertDocumentXlsToPdf_help() {
    echo ""
    echo -e "${BOLD}${WHITE}convertDocumentXlsToPdf - Excel XLS (97-03) to PDF${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_convertDocumentXlsToXlsx_help() {
    echo ""
    echo -e "${BOLD}${WHITE}convertDocumentXlsToXlsx - Excel XLS (97-03) to XLSX${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_convertDocumentXlsxToCsv_help() {
    echo ""
    echo -e "${BOLD}${WHITE}convertDocumentXlsxToCsv - Excel XLSX to CSV${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Convert Office Excel Workbooks (xlsx) to standard Comma-Separated Values (CSV) format." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
...
print_convertDocumentXlsxToPdf_help() {
    echo ""
    echo -e "${BOLD}${WHITE}convertDocumentXlsxToPdf - Excel XLSX to PDF${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Convert Office Excel Workbooks (xlsx) to standard PDF.  Converts all worksheets in the workbook to PDF." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
...
print_convertWebHtmlToDocx_help() {
    echo ""
    echo -e "${BOLD}${WHITE}convertWebHtmlToDocx - HTML to DOCX${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_editDocumentBeginEditing_help() {
    ...
    echo -e ""
    echo -e "Uploads a document to Cloudmersive to begin a series of one or more editing operations" | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
...
print_editDocumentDocxBody_help() {
    echo ""
    echo -e "${BOLD}${WHITE}editDocumentDocxBody - Get body from a DOCX${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_editDocumentDocxGetHeadersAndFooters_help() {
    echo ""
    echo -e "${BOLD}${WHITE}editDocumentDocxGetHeadersAndFooters - Get content of a footer from a DOCX${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_editDocumentDocxGetImages_help() {
    echo ""
    echo -e "${BOLD}${WHITE}editDocumentDocxGetImages - Get images from a DOCX${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_editDocumentDocxGetSections_help() {
    echo ""
    echo -e "${BOLD}${WHITE}editDocumentDocxGetSections - Get sections from a DOCX${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_editDocumentDocxGetStyles_help() {
    echo ""
    echo -e "${BOLD}${WHITE}editDocumentDocxGetStyles - Get styles from a DOCX${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_editDocumentDocxGetTables_help() {
    echo ""
    echo -e "${BOLD}${WHITE}editDocumentDocxGetTables - Get tables in DOCX${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_editDocumentDocxInsertImage_help() {
    echo ""
    echo -e "${BOLD}${WHITE}editDocumentDocxInsertImage - Insert image into a DOCX${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Set the footer in a Word Document (DOCX)" | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json,text/json,application/xml,text/xml,application/x-www-form-urlencoded]${OFF} ${RED}(required)${OFF}${OFF} - " | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_editDocumentDocxInsertParagraph_help() {
    echo ""
    echo -e "${BOLD}${WHITE}editDocumentDocxInsertParagraph - Insert a new paragraph into a DOCX${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Adds a new paragraph into a DOCX and returns the result.  You can insert at the beginning/end of a document, or before/after an existing object using its Path (location within the document)." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json,text/json,application/xml,text/xml,application/x-www-form-urlencoded]${OFF} ${RED}(required)${OFF}${OFF} - " | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_editDocumentDocxInsertTable_help() {
    echo ""
    echo -e "${BOLD}${WHITE}editDocumentDocxInsertTable - Insert a new table into a DOCX${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Adds a new table into a DOCX and returns the result" | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json,text/json,application/xml,text/xml,application/x-www-form-urlencoded]${OFF} ${RED}(required)${OFF}${OFF} - " | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_editDocumentDocxRemoveHeadersAndFooters_help() {
    echo ""
    echo -e "${BOLD}${WHITE}editDocumentDocxRemoveHeadersAndFooters - Remove headers and footers from DOCX${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Remove all headers, or footers, or both from a Word Document (DOCX)" | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json,text/json,application/xml,text/xml,application/x-www-form-urlencoded]${OFF} ${RED}(required)${OFF}${OFF} - " | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_editDocumentDocxRemoveObject_help() {
    echo ""
    echo -e "${BOLD}${WHITE}editDocumentDocxRemoveObject - Delete any object in a DOCX${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Delete any object, such as a paragraph, table, image, etc. from a Word Document (DOCX).  Pass in the Path of the object you would like to delete.  You can call other functions such as Get-Tables, Get-Images, Get-Body, etc. to get the paths of the objects in the document." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json,text/json,application/xml,text/xml,application/x-www-form-urlencoded]${OFF} ${RED}(required)${OFF}${OFF} - " | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_editDocumentDocxReplace_help() {
    echo ""
    echo -e "${BOLD}${WHITE}editDocumentDocxReplace - Replace string in DOCX${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_editDocumentDocxSetFooter_help() {
    echo ""
    echo -e "${BOLD}${WHITE}editDocumentDocxSetFooter - Set the footer in a DOCX${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Set the footer in a Word Document (DOCX)" | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
...
print_editDocumentDocxSetHeader_help() {
    echo ""
    echo -e "${BOLD}${WHITE}editDocumentDocxSetHeader - Set the header in a DOCX${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Set the header in a Word Document (DOCX)" | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json,text/json,application/xml,text/xml,application/x-www-form-urlencoded]${OFF} ${RED}(required)${OFF}${OFF} - " | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_editDocumentFinishEditing_help() {
    echo ""
    echo -e "${BOLD}${WHITE}editDocumentFinishEditing - Download result from document editing${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_editDocumentPptxReplace_help() {
    echo ""
    echo -e "${BOLD}${WHITE}editDocumentPptxReplace - Replace string in PPTX${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_editDocumentXlsxGetColumns_help() {
    echo ""
    echo -e "${BOLD}${WHITE}editDocumentXlsxGetColumns - Get rows and cells from a XLSX worksheet${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_editDocumentXlsxGetImages_help() {
    echo ""
    echo -e "${BOLD}${WHITE}editDocumentXlsxGetImages - Get images from a XLSX worksheet${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_editDocumentXlsxGetRowsAndCells_help() {
    echo ""
    echo -e "${BOLD}${WHITE}editDocumentXlsxGetRowsAndCells - Get rows and cells from a XLSX worksheet${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Returns the rows and cells defined in the Excel Spreadsheet worksheet" | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
...
print_editDocumentXlsxGetStyles_help() {
    echo ""
    echo -e "${BOLD}${WHITE}editDocumentXlsxGetStyles - Get styles from a XLSX worksheet${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_editDocumentXlsxGetWorksheets_help() {
    echo ""
    echo -e "${BOLD}${WHITE}editDocumentXlsxGetWorksheets - Get worksheets from a XLSX${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_editDocumentXlsxInsertWorksheet_help() {
    echo ""
    echo -e "${BOLD}${WHITE}editDocumentXlsxInsertWorksheet - Insert a new worksheet into an XLSX spreadsheet${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_mergeDocumentDocx_help() {
    echo ""
    echo -e "${BOLD}${WHITE}mergeDocumentDocx - Merge Multple Word DOCX Together${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_mergeDocumentPptx_help() {
    echo ""
    echo -e "${BOLD}${WHITE}mergeDocumentPptx - Merge Multple PowerPoint PPTX Together${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
print_mergeDocumentXlsx_help() {
    echo ""
    echo -e "${BOLD}${WHITE}mergeDocumentXlsx - Merge Multple Excel XLSX Together${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
