...
(Get-Content ./client/cloudmersive-cli).replace("if [[ -z `"$host`" ]]; then`r`nERROR_MSG=`"ERROR: No hostname provided!!! You have to  provide on command line option '--host ...'`"`r`nexit 1`r`nfi","") | Set-Content ./client/cloudmersive-cli
